...
condition1 && condition2 : 두 조건을 모두 만족시킬 때 true

condition1 || condition2 : 두 조건 중 하나만 만족시켜도 true

! condition1 && condition2 : 두 조건 모두 만족시킬 때 false

! condition1 || condition2 : 두 조건 중 하나만 만족시켜도 false
